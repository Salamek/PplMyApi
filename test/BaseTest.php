...
abstract class BaseTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->package = new Package(115, Product::PPL_PARCEL_CZ_PRIVATE, 10, 'Testpvaci balik', Depo::CODE_09, $recipient, $sender);

        $this->packages[] = new Package(116, Product::PPL_PARCEL_CZ_PRIVATE, 1, 'Testpvaci balik 1', Depo::CODE_01, $recipient, $sender);


        //These two are together and first one is with POD
        $paymentInfo = new PaymentInfo(4000, Currency::CZK, '123456');
        $packageFirst = new Package(117, Product::PPL_PARCEL_CZ_PRIVATE_COD, 2, 'Testpvaci balik 2', Depo::CODE_02, $recipient, $sender, null, $paymentInfo);
        $packageFirst->setPackageCount(2);
        $packageFirst->setPackagePosition(1);

        $paymentInfoNull = new PaymentInfo(0, Currency::CZK, '123456');
        $packageSecond = new Package(118, Product::PPL_PARCEL_CZ_PRIVATE_COD, 3, 'Testpvaci balik 3', Depo::CODE_02, $recipient, $sender, null, $paymentInfoNull);
        ...
        $this->packages[] = new Package(119, Product::PPL_PARCEL_CZ_PRIVATE, 4, 'Testpvaci balik 4', Depo::CODE_04, $recipient, $sender);
        $this->packages[] = new Package(120, Product::PPL_PARCEL_CZ_PRIVATE, 5, 'Testpvaci balik 5', Depo::CODE_05, $recipient, $sender);
    }
